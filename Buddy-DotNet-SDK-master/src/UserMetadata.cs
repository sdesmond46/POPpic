...
namespace Buddy
{
    ...
    /// </example>
    /// </summary>
    public class UserMetadata : BuddyBase
    {
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of GetAllAsync.")]
        ...
        {
            this.Client.Service.MetaData_UserMetaDataValue_GetAll (this.Client.AppName, this.Client.AppPassword, this.Token, (bcr) =>
            {
                ...
                foreach (var d in result)
                    dict.Add (d.MetaKey, new MetadataItem (this.Client, this, null, this.Token, d.MetaKey, d.MetaValue,
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of GetAsync.")]
        ...
        internal void GetInternal (string key, Action<BuddyCallResult<MetadataItem>> callback)
        {
            ...
            this.Client.Service.MetaData_UserMetaDataValue_Get (this.Client.AppName, this.Client.AppPassword, this.Token, key, (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != BuddyError.None) {
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of SetAsync.")]
        ...
        internal void SetInternal (string key, string value, double latitude, double longitude, string appTag, Action<BuddyCallResult<bool>> callback)
        {
            ...
            this.Client.Service.MetaData_UserMetaDataValue_Set (this.Client.AppName, this.Client.AppPassword, this.Token, key, value, latitude.ToString (CultureInfo.InvariantCulture),
        ...
        /// <exception cref="System.ArgumentException">When any key is null or empty.</exception>
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of DeleteAsync.")]
        ...
        internal void DeleteInternal (string key, Action<BuddyCallResult<bool>> callback)
        {
            ...
            this.Client.Service.MetaData_UserMetaDataValue_Delete (this.Client.AppName, this.Client.AppPassword, this.Token, key, (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != BuddyError.None && bcr.Error != BuddyError.ServiceErrorNegativeOne) {
                    callback (BuddyResultCreator.Create (false, bcr.Error));
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of DeleteAllAsync.")]
        ...
        {
            this.Client.Service.MetaData_UserMetaDataValue_DeleteAll (this.Client.AppName, this.Client.AppPassword, this.Token, (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != BuddyError.None && bcr.Error != BuddyError.ServiceErrorNegativeOne) {
                    callback (BuddyResultCreator.Create (false, bcr.Error));
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of FindAsync.")]
                    ...
                    bool disableCache = false, object state = null)
        {
            FindInternal (searchDistanceMeters, latitude, longitude, numberOfResults, withKey, withValue,
                updatedMinutesAgo, searchAsFloat, sortAscending, disableCache, (bcr) => {
                if (callback == null)
                    return;
                callback (bcr.Result, new BuddyCallbackParams (bcr.Error)); });
            return null;
        ...
        internal void FindInternal (int searchDistanceMeters, double latitude, double longitude, int numberOfResults,
                    string withKey, string withValue, int updatedMinutesAgo, bool searchAsFloat, bool sortAscending, bool disableCache, Action<BuddyCallResult<Dictionary<string, MetadataItem>>> callback)
        {
            this.Client.Service.MetaData_UserMetaDataValue_Search (this.Client.AppName, this.Client.AppPassword, this.Token, searchDistanceMeters.ToString (),
                    latitude.ToString (CultureInfo.InvariantCulture), longitude.ToString (CultureInfo.InvariantCulture), numberOfResults.ToString (), withKey, withValue, updatedMinutesAgo.ToString (), searchAsFloat ? "1" : "0",
                    sortAscending ? "1" : "0", disableCache ? "true" : "", (bcr) =>
            {
                var result = bcr.Result;
                if (bcr.Error != BuddyError.None) {
                    callback (BuddyResultCreator.Create<Dictionary<string, MetadataItem>> (null, bcr.Error));
                ...
                Dictionary<string, MetadataItem> dict = new Dictionary<string, MetadataItem> ();
                foreach (var d in result)
                    dict.Add (d.MetaKey, new MetadataItem (this.Client, this, null, this.Token, d, latitude, longitude));
                {
                    callback (BuddyResultCreator.Create (dict, bcr.Error));
                    return; }
                ;
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of SumAsync.")]
        ...
        {
            this.Client.Service.MetaData_UserMetaDataValue_Sum (this.Client.AppName, this.Client.AppPassword, this.Token,
                    forKeys, withinDistance.ToString (), latitude.ToString (CultureInfo.InvariantCulture), longitude.ToString (CultureInfo.InvariantCulture), updatedMinutesAgo.ToString (), withAppTag, (bcr) =>
            {
                ...
                {
                    callback (BuddyResultCreator.Create (new MetadataSum (String.IsNullOrEmpty (result [0].TotalValue) ? 0 : Double.Parse (result [0].TotalValue, CultureInfo.InvariantCulture),
                               Int32.Parse (result [0].KeyCount, CultureInfo.InvariantCulture), forKeys), bcr.Error));
                    return;
                }
                ;
            });
	...
	[Obsolete("This method has been deprecated, please call one of the other overloads of BatchSumAsync.")]
                    ...
                    int updatedMinutesAgo, string withAppTag, Action<BuddyCallResult<List<MetadataSum>>> callback)
        {
            ...
            this.Client.Service.MetaData_UserMetaDataValue_BatchSum (this.Client.AppName, this.Client.AppPassword, this.Token,
           ...
           public System.Threading.Tasks.Task<MetadataItem> GetAsync( string key)
            ...
            /// <param name="latitude">The optional latitude of the metadata item.</param>
            /// <param name="longitude">The optional longitude of the metadata item.</param>
            /// <param name="appTag">The optional application tag for this item.</param><exception cref="T:System.ArgumentException">When key is null or empty.</exception><exception cref="T:System.ArgumentNullException">When value is null.</exception>
           ...
           public System.Threading.Tasks.Task<MetadataSum> SumAsync( string forKeys, int withinDistance = -1, double latitude = -1, double longitude = -1, int updatedMinutesAgo = -1, string withAppTag = "")
            {
